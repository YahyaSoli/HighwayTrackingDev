                                     ...
                                     const emlrtRTEInfo *srcLocation)
{
  ...
  dst->SensorSpecifications = src->SensorSpecifications;
                                     ...
                                     fusion_tracker_JIPDATracker *pStruct)
{
  ...
  e_emxFreeStruct_fusion_tracker_(sp, &pStruct->_pobj3);
}
                                     ...
                                     const emlrtRTEInfo *srcLocation)
{
  c_emxInitStruct_fusion_tracker_(sp, &pStruct->TrackListManager, srcLocation,
                                  false);
  e_emxInitStruct_fusion_tracker_(sp, &pStruct->_pobj3, srcLocation);
}
...
void e_emxInitStruct_fusion_tracker_(const emlrtStack *sp,
                                     ...
                                     const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->ProcessingTimestamps, srcLocation, false);
}
                                 ...
                                 const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)i * sizeof(struct4_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
      memcpy(newData, emxArray->data, sizeof(struct4_T) * (uint32_T)oldNumel);
      if (emxArray->canFreeData) {
        emlrtFreeMex(emxArray->data);
      }
    }
                                ...
                                const emlrtRTEInfo *srcLocation)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = emlrtMallocMex((uint32_T)i * sizeof(b_struct_T));
    if (newData == NULL) {
      emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
    }
    if (emxArray->data != NULL) {
                       ...
                       const emlrtRTEInfo *srcLocation)
{
  ...
  *pEmxArray =
      (emxArray_struct4_T *)emlrtMallocEmxArray(sizeof(emxArray_struct4_T));
  if ((void *)*pEmxArray == NULL) {
    emlrtHeapAllocationErrorR2012b(srcLocation, (emlrtCTX)sp);
  }
  emlrtPushHeapReferenceStackEmxArray((emlrtCTX)sp, true, (void *)pEmxArray,
                                      (void *)&emxFree_struct4_T, NULL, NULL,
                                      NULL);
  emxArray = *pEmxArray;
...
/* End of code generation (trackerEntryPoint_emxutil.c) */
