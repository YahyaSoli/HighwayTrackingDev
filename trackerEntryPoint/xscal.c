...
void d_xscal(const emlrtStack *sp, real_T a, real_T x[9], int32_T ix0)
{
  emlrtStack b_st;
  emlrtStack c_st;
  emlrtStack st;
...
void e_xscal(const emlrtStack *sp, real_T x[9], int32_T ix0)
{
  emlrtStack b_st;
  emlrtStack c_st;
  emlrtStack st;
...
void xscal(const emlrtStack *sp, int32_T n, real_T a, real_T x[100],
           int32_T ix0)
{
  emlrtStack b_st;
  emlrtStack c_st;
