 ...
 *
 * _coder_trackerEntryPoint_info.c
 *
...
/* Include files */
#include "_coder_trackerEntryPoint_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "QualifiedName",
                emlrtMxCreateString("trackerEntryPoint"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString("C:\\Users\\20200866\\OneDrive - TU "
                          "Eindhoven\\Documents\\MATLAB\\Examples\\R2024b\\fusi"
                          "on\\HighwayVehicleTrackingForAutomotiveAp"
                          "plicationsExample\\trackerEntryPoint.m"));
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739759.500625));
...
/* End of code generation (_coder_trackerEntryPoint_info.c) */
